...
## Формат
Это чеклистовый companion к `.flow/docs/flow-onboarding-quickstart.md`.
...
Если нужен контекст, пояснения и troubleshooting, переключайтесь на `.flow/docs/flow-onboarding-quickstart.md` и `.flow/docs/flow-portability-runbook.md`.
Для расшифровки repo Actions secrets используйте `.flow/docs/github-actions-repo-secrets.md`.
