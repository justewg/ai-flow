...
4. Сохрани изменения и расположи опции в порядке: `Backlog`, `Todo`, `In Progress`, `Review`, `Done`, `Closed`.
5. В board-view убедись, что отображаются соответствующие колонки.
