...
function buildIntakeInterpretationRequest(input) {
  ...
  const promptSections = [
    ...
    [
      ...
      "- In PLANKA, ai-flow toolkit/runtime/submodule work is standard unless it is docs-only; the ai-flow toolkit submodule path is .flow/shared; do not invent a generic ai-flow target path.",
