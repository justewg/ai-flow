...
function normalizeProviderTelemetryRecord(input) {
  ...
  return {
    ...
    machineReadableMarkersPrimary: optionalBoolean(input.machineReadableMarkersPrimary),
    ...
    explanationCompletenessShadow: optionalBoolean(input.explanationCompletenessShadow),
    specificityQuestionPrimary: optionalBoolean(input.specificityQuestionPrimary),
    specificityQuestionShadow: optionalBoolean(input.specificityQuestionShadow),
