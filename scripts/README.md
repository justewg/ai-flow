...
- `.flow/shared/scripts/run.sh runtime_v2_status_text` — короткий текстовый alias для `runtime_v2_inspect`, симметричный `runtime_v2_status`/`runtime_v2_status_json` для operator status-check.
