...
bind="$(resolve_config_value "GH_APP_BIND" "127.0.0.1")"
port="$(resolve_config_value "GH_APP_PORT" "8787")"
secret="$(resolve_config_value "GH_APP_INTERNAL_SECRET" "")"
timeout_sec="$(resolve_config_value "DAEMON_GH_AUTH_TIMEOUT_SEC" "8")"
custom_token_url="$(resolve_config_value "DAEMON_GH_AUTH_TOKEN_URL" "")"
