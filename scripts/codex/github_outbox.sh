...
usage() {
  cat <<'USAGE'
Usage:
  scripts/codex/github_outbox.sh enqueue_issue_comment <repo> <issue-number> <body-file> [task-id] [kind] [set-waiting]
  scripts/codex/github_outbox.sh flush
  scripts/codex/github_outbox.sh count
  scripts/codex/github_outbox.sh list
USAGE
}
