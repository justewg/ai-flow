...
apps_file="$(mktemp "${STATE_TMP_DIR}/app_deps_apps.XXXXXX.json")"
nodes_raw_file="$(mktemp "${STATE_TMP_DIR}/app_deps_nodes_raw.XXXXXX.txt")"
nodes_sorted_file="$(mktemp "${STATE_TMP_DIR}/app_deps_nodes_sorted.XXXXXX.txt")"
edges_raw_file="$(mktemp "${STATE_TMP_DIR}/app_deps_edges_raw.XXXXXX.txt")"
edges_sorted_file="$(mktemp "${STATE_TMP_DIR}/app_deps_edges_sorted.XXXXXX.txt")"
warnings_raw_file="$(mktemp "${STATE_TMP_DIR}/app_deps_warnings_raw.XXXXXX.txt")"
warnings_sorted_file="$(mktemp "${STATE_TMP_DIR}/app_deps_warnings_sorted.XXXXXX.txt")"
