...
usage() {
  cat <<'EOF'
Usage:
  .flow/shared/scripts/log_summary.sh [--hours N] [--from ISO_UTC] [--to ISO_UTC]

Examples:
  .flow/shared/scripts/log_summary.sh
  .flow/shared/scripts/log_summary.sh --hours 6
  .flow/shared/scripts/log_summary.sh --from 2026-02-28T00:00:00Z --to 2026-02-28T12:00:00Z
EOF
}
