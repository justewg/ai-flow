...
usage() {
  cat <<'EOF'
Usage:
  .flow/shared/scripts/ops_bot_webhook_register.sh register
  .flow/shared/scripts/ops_bot_webhook_register.sh refresh
  .flow/shared/scripts/ops_bot_webhook_register.sh delete
