...
ensure_state_namespace_layout() {
  ...
  local -a file_links=(
    ...
    "daemon:daemon_claim_pending_issue_number.txt"
    "daemon:daemon_claim_pending_item_id.txt"
    "daemon:daemon_claim_pending_started_utc.txt"
    "daemon:daemon_claim_pending_task_id.txt"
